    ...
    private void updateStateInDatabase ()
    {
        try {
            if (persistentState.getProperty("ID") != null) {
                ...
                treeTypeUpdateStatusMessage = "Tree type data for tree type: " + persistentState.getProperty("TypeDescription") + " updated successfully in database!";
            } else {
                int treeTypeId =
                        insertAutoIncrementalPersistentState(mySchema, persistentState);
                persistentState.setProperty("ID", "" + treeTypeId);
                treeTypeUpdateStatusMessage = "Tree type data for new tree type: " + persistentState.getProperty("TypeDescription") + " installed successfully in database!";
            }
        } catch (SQLException ex) {
            treeTypeUpdateStatusMessage = "ERROR: Error in installing tree type data in database!";
        }
