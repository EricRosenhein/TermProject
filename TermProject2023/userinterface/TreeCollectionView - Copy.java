...
public class TreeCollectionView extends View {
	...
	//--------------------------------------------------------------------------
	public TreeCollectionView(IModel trans)
	{
		super(trans, "TreeCollectionView");
		...
		// DEBUG System.out.println("PatronCollectionView: created form content");
	...
	{
		System.out.println("TreeCollectionView: getting here");
   ...
   protected void getEntryTableModelValues()
   {
    ...
    try
    {
        TreeCollection treeCollection = (TreeCollection)myModel.getState("TreeList"); //May need to change key

        Vector entryList = (Vector)treeCollection.getState("Trees"); //May need to change
        System.out.println("Number of Trees to show: " + entryList.size());
	...
	private Node createTitle()
	{
		...
		Text titleText = new Text(" Wyhsenhein's Tree Sales ");		
	...
	private VBox createFormContent()
    {
		...
		TableColumn treeBarcodeColumn = new TableColumn("Tree Barcode") ;
		treeBarcodeColumn.setMinWidth(200);
		treeBarcodeColumn.setCellValueFactory(
	                new PropertyValueFactory<TreeTableModel, String>("treeBarcode"));
                    
        TableColumn treeNotesColumn = new TableColumn("Notes") ;
        treeNotesColumn.setMinWidth(200);
        treeNotesColumn.setCellValueFactory(
                    new PropertyValueFactory<TreeTableModel, String>("treeNotes"));
	...
	protected void processTreeSelected()
	{
		...
		if(selectedItem != null)
		{
			...
			String selectedTreeBarcode = selectedItem.getBarcode();
